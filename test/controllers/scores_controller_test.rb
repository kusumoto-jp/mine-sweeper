...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { clear_time: @score.clear_time, client: @score.client, level: @score.level, name: @score.name }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { clear_time: @score.clear_time, client: @score.client, level: @score.level, name: @score.name }
    assert_redirected_to score_path(assigns(:score))
  end
